...
public class addCita extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("ToothCenter - Añadir Cita");
        setResizable(false);
   ...
   public void llenarcmb()
    ...
    private void btn173ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn173ActionPerformed
        try{
            validarFecha();
            hrcita="17:30";
            if(javax.swing.JOptionPane.showConfirmDialog(rootPane,"Agendarás una cita para "+txtpaciente.getText()+" a las "+hrcita+" hrs.")!=0)
            {
                return;
            }
            else
